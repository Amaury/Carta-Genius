...
/* $Id: pdflib.h,v 1.1 2006/06/19 10:23:04 amaury Exp $
 *
...
#define PDFLIB_VERSIONSTRING	"6.0.0"       /* The whole bunch */
...
/* Request a slot's unicode value from a custom encoding (unsupported). */
PDFLIB_API int PDFLIB_CALL
